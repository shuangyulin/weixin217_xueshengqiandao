<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到时间" prop="qiandaoshijian">
          <el-input v-model="ruleForm.qiandaoshijian" 
              placeholder="签到时间" clearable  :readonly="ro.qiandaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到时间" prop="qiandaoshijian">
              <el-input v-model="ruleForm.qiandaoshijian" 
