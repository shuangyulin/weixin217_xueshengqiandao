<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="销假编号" prop="xiaojiabianhao">
            <el-input v-model="ruleForm.xiaojiabianhao" 
                placeholder="销假编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaojiabianhao" label="销假编号" prop="xiaojiabianhao">
              <el-input v-model="ruleForm.xiaojiabianhao" 
                placeholder="销假编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销假标题" prop="xiaojiabiaoti">
          <el-input v-model="ruleForm.xiaojiabiaoti" 
              placeholder="销假标题" clearable  :readonly="ro.xiaojiabiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销假标题" prop="xiaojiabiaoti">
              <el-input v-model="ruleForm.xiaojiabiaoti" 
                placeholder="销假标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="归校时间" prop="guixiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.guixiaoshijian" 
                type="datetime"
                :readonly="ro.guixiaoshijian"
                placeholder="归校时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guixiaoshijian" label="归校时间" prop="guixiaoshijian">
              <el-input v-model="ruleForm.guixiaoshijian" 
                placeholder="归校时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="销假时间" prop="xiaojiashijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiaojiashijian" 
                type="date"
                :readonly="ro.xiaojiashijian"
                placeholder="销假时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaojiashijian" label="销假时间" prop="xiaojiashijian">
              <el-input v-model="ruleForm.xiaojiashijian" 
                placeholder="销假时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.xiaojiashijian = this.getCurDate()
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaojiaxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaojiaxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
