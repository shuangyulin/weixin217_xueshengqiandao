<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:30px;backgroundColor:rgba(185, 231, 254, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:5px;borderStyle:double;borderColor:rgba(112, 112, 112, 1);">
