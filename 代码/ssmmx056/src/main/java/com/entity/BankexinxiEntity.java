...
public class BankexinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public BankexinxiEntity() {
		
	}
	
	public BankexinxiEntity(T t) {
		try {
	 ...
	 * 设置：班课编号
	 */
	public void setBankebianhao(String bankebianhao) {
		this.bankebianhao = bankebianhao;
	}
	/**
	 * 获取：班课编号
	 */
	public String getBankebianhao() {
		return bankebianhao;
	}
	/**
	 * 设置：课程名称
