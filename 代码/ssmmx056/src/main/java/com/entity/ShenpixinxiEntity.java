...
public class ShenpixinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShenpixinxiEntity() {
		
	}
	
	public ShenpixinxiEntity(T t) {
		try {
	 ...
	 * 设置：审批编号
	 */
	public void setShenpibianhao(String shenpibianhao) {
		this.shenpibianhao = shenpibianhao;
	}
	/**
	 * 获取：审批编号
	 */
	public String getShenpibianhao() {
		return shenpibianhao;
	}
	/**
	 * 设置：标题
	 */
